...
3. Chequeo previo en cada máquina: `python scripts/verificar_prod.py`
   (valida carpeta escribible + credenciales + Chrome).
4. Crear las tareas del Programador siguiendo
