...
SECCIONES: dict[str, dict] = {
    ...
    "Clientes Renta Fija Local": {
        ...
        # NOTA: existe la seccion 'Historico betas' (#hisbe), pero NO descarga
        # archivos: solo muestra en pantalla los coeficientes (Beta 0/1/2/Tao)
        # de la curva elegida. El dato de la curva TES B en Pesos ya viene en
        # los archivos de valoracion de Renta Fija (SB...), asi que no se mapea.
